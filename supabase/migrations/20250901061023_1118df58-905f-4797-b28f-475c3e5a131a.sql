-- Corrigir search_path nas funções sem dropar a que está em uso

-- Atualizar função handle_new_user existente com search_path seguro
...
-- Criar função update_user_location com search_path seguro
...
-- Criar função get_nearby_users com search_path seguro
